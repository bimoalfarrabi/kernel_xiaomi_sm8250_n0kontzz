					       ...
					       bool enable)
{
	...
	if (enable) {
		...
		queue_delayed_work(
			system_power_efficient_wq, &chg->conn_therm_work,
...
int smblib_init(struct smb_charger *chg)
{
	...
	queue_delayed_work(system_power_efficient_wq, &chg->status_report_work,
